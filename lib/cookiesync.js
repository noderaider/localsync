...
function cookiesync(key, action, handler, _a) {
    ...
    var loadCookie = function () {
        try {
            var value = universal_cookie_1.default.get(cookieKey, { doNotParse: false });
            ...
            universal_cookie_1.default.remove(cookieKey);
        }
    };
    var saveCookie = function () {
        ...
        universal_cookie_1.default.set(cookieKey, value, cookieOpts);
    };
    var isRunning = false;
